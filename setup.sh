...
echo 'export default function Home() {
  return <div className="flex h-screen w-full items-center justify-center bg-black font-mono"><p className="text-purple-500 font-semibold text-3xl">Coded by Dikshith</p></div>;
}
' > index.js
cd ..
npm run dev
